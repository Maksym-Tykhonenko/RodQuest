...
import RodQuestProdactScreen from './screen/RodQuestProdactScreen';
///////////////////////////////////////////
...
function App() {
  ...
  const INITIAL_URL_KEY = 'https://incredible-magnificent-game.space/cwqz5KNr';
  ...
  ///////// OneSignall
  // 3c5002b6-749f-4b8d-8c92-830068c98930
  ...
  OneSignal.initialize('3c5002b6-749f-4b8d-8c92-830068c98930');
  ...
  OneSignal.Notifications.addEventListener('click', event => {
    if (event.notification.launchURL) {
      ...
      fetch(
        `${INITIAL_URL_KEY}?utretg=push_open_webview&jthrhg=${timestamp_user_id}`,
      );
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="RodQuestProdactScreen"
            component={RodQuestProdactScreen}
      ...
      <NavigationContainer>
        {!louderIsEnded ? (
          <View
            ...
            <Animated.Image
              source={require('./assets/newBg/loader1.png')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./assets/newBg/loader2.png')}
              style={{
                //...props.style,
