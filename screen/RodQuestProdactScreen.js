...
const RodQuestProdactScreen = ({navigation, route}) => {
  ...
  ////////////////////////////
  let baseUrl = `${INITIAL_URL_KEY}?cwqz5KNr=1&advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}&customer_user_id=${customerUserId}&idfv=${idfv}&onesignal_id=${oneSignalId}`;
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/newBg/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/newBg/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
